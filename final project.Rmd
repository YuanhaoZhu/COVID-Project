---
title: "final project"
author: "Yuanhao Zhu, Michael Russo, Yuhan Hu, Jiayi Guo, Ziqu Wang"
date: "4/18/2021"
...
> Thus the formula of our model is ：

HDI = $\beta_1 *logTC +\beta_2*STI+\beta_3*logPOP + \beta_4*logTD*developed+\beta_5*logTD*developing +\beta_6*logTD*underdeveloped $

> We also want to the relationship between total death and Human development index.We regressed HDI against log total case, stringency index, log population and the interaction term between log total death and type of countries. We used both robust and ordinary least square method and found that both methods yield consistent results for our covariates. We see that there is a statistically significant negative association between population size and HDI, indicating that the large population will cause many socio-economic problem. Thus, those countries  will very large population size tend to have smaller HDI. Most importantly, the coefficients associated with the interaction terms are significant. And for developed countries and developing countries, there is a positive association beween log total death and HDI. However, this relationship is reversed for underdeveloped countries. This result may suggest that due to the more established economic and industrial system for the developing and developed countries, the HDI is higher than the underdeveloped countries. But, since HDI is positively highly correlated with GDP per capita as shown in model 1, a higher HDI suggests a more active economy, which will faciliate the transmission of disease and thus more death. However, for the underdeveloped countries, the economy is much less active. A higher HDI is an indication of a great improvement of living standard or  medical conditions, thus the total death is negatively associated with HDI for underdeveloped countries.
